...
from adafruit_drivers import PWM

from hat_driver.constants import LOW, HIGH
from hat_driver.gpio import (
    LOW as GPIO_LOW,
    HIGH as GPIO_HIGH
)
from hat_driver.pwm import (
    LOW as PWM_LOW,
    HIGH as PWM_HIGH
)
...
if ROBOT_HARDWARE in [DeviceHardwareBrand.RASPBERRY_PI,
    DeviceHardwareBrand.RASPBERRY_PI_64]:
...
class AbsMotorDirectionController(ABC):
    ...
    def __str__(self):
        return f"{self.__class__.__name__}\
            [in1={self._in1_pin}, in2={self._in2_pin}]"
...
class PWMMotorDirectionController(AbsMotorDirectionController):
    ...
    def set(self, direction: MotorDirection):
        ...
        in1_value, in2_value = self._PWM_VALUES[in1_signal],\
...
class GPIOMotorDirectionController(AbsMotorDirectionController):
    ...
    def set(self, direction: MotorDirection):
        in1_signal, in2_signal = self._DIRECTION_TO_SIGNALS[direction]
        in1_value, in2_value = self._GPIO_VALUES[in1_signal],\
...
class Motor:
    ...
    def __init__(self, name: str, pwm: PWM, in1_pin: int, in2_pin: int,
        pwm_pin: int, control: MotorDirectionControl
    ):
        self._pwm = pwm
        self._name = name
        self._in1_pin = in1_pin
        ...
        self._controller = self._CONTROLLER[control](
            in1_pin, in2_pin, pwm=self._pwm)
    ...
    def __str__(self):
        return f"""Motor[name={self._name}, in1={self._in1_pin},
            in2={self._in2_pin}, pwm={self._pwm_pin},
