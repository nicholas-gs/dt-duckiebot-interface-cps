...
from button_driver.led import ButtonLED
...
class ButtonDriver:
    """Class handling communication with a GPIO button.
        Args:
            led_gpio_pin (:obj:`int`): ID of the pin the button LED is
                connected to.
            signal_gpio_pin (:obj:`int`): ID of the pin the button (signal) is
                connected to.
            callback (:obj:`callable`): callback function to receive signal
                events.
    """
    def __init__(self,
        led_gpio_pin: int,
